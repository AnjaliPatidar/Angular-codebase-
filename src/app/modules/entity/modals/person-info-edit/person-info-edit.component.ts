...
@Component({
  ...
  styleUrls: ['./person-info-edit.component.scss']
})
export class PersonInfoEditComponent implements OnInit {
//new Code starts 

@Input('modalData') PersonmodalData;
@Input('statickeys') statickeys;
//new Code Ends 
  ...
  ngOnInit() {
    this.overrideValue = this.PersonmodalData && this.PersonmodalData.source? this.PersonmodalData.source :'';
    // this.sourceList_forModal = $.extend(true, [], this.sourceList);
    // this.onload();
  }
  ...
  onload() {
    ...
    //   if (_.findIndex(this.primarySource, (d) => { return d.source == this.overrideValue }) >= 0) {
    //     this.accordian.primaryOpen = !this.accordian.primaryOpen;
    //     this.activePanelId = "primary-panel";
    //   } else if (_.findIndex(this.secondarySource, (d) => { return d.source == this.overrideValue }) >= 0) {
    //     this.accordian.secondaryOpen = !this.accordian.secondaryOpen;
    //     this.activePanelId = "secondary-panel";
    //   }
    // }
