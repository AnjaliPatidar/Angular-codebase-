   ...
   y.domain(ymin,ydomain[1]) */
    ...
    function plottimescaleBubbleChart(data) {
        ...
        var x_g = g.append("g")
                ...
                .call(d3.axisBottom(x).ticks(_this.xticks)).attr("class", "axis")
        x_g.append("text")
                .attr("transform", "translate(" + (width / 2) + "," + 30 + ")")
                .attr("x", timeScale2Values.xAxisTextX).attr("y", timeScale2Values.xAxisTextY)
                .attr("dx", timeScale2Values.xAxisTextDX)
        ...
        y_g.append("text")
                ...
                .attr("y", -margin.left)
                .attr("dy", timeScale2Values.yAxisTextDY)
                .attr("dx", timeScale2Values.yAxisTextdx)
        ...
        g.selectAll("circle")
                ...
                .attr("cy", 0)
                .transition().duration(timeScale2Values.bubbleDuration).ease(d3.easeLinear)
                .attr("cy", function (d) {
                    return y(d.rate)
                })
