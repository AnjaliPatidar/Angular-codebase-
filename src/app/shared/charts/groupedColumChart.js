        ...
        function drawColumns(data) {
                ...
                var groupedG = g.append("g")
                        ...
                        .attr("transform", function (d) {
                                if (barOptions.container == '#groupBarChart') {
                                        if (barOptions.data.length > 1) {
                                                return "translate(" + (x0(d.x) - 40) + ",0)";
                                        } else {
                                                return "translate(" + (x0(d.x) - 30) + ",0)";
                                        }
